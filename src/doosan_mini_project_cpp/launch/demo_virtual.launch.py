...
def generate_launch_description():
    ...
    ARGUMENTS =[ 
        ...
        # 그리퍼 여부
        DeclareLaunchArgument("gripper", default_value="robotis_rh_p12_rn",      description="Gripper type: none or robotis_rh_p12_rn",
    )
    ]
    ...
    moveit_config = (
        MoveItConfigsBuilder(
            "e0509",
            package_name="dsr_moveit_config_e0509",
        )
        .robot_description(file_path="config/e0509.urdf.xacro")
    ...
    rviz_base = os.path.join(
        get_package_share_directory("dsr_moveit_config_e0509"), "launch"
    )
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("dsr_moveit_config_e0509"),
        "config",
